...
public class EmployeeByFullNameFilterStrategy extends FilterOutputStrategy<Employee> {

    private final Scanner scanner;

    public EmployeeByFullNameFilterStrategy(
    ...
    public Predicate<Employee> predicate() {
        ...
        return employee -> employee.fullName().toLowerCase().contains(line.toLowerCase());
    }
}
